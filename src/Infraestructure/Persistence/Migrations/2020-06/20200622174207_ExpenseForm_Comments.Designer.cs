...
namespace Prome.Viaticos.Server.Infraestructure.Persistence.Migrations
{
    ...
    [Migration("20200622174207_ExpenseForm_Comments")]
    partial class ExpenseForm_Comments
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Prome.Viaticos.Server.Domain.Entities.ExpenseFormAggreate.ExpenseForm", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Prome.Viaticos.Server.Domain.Entities.ExpenseFormAggreate.ExpenseFormAudit", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Prome.Viaticos.Server.Domain.Entities.ExpenseFormAggreate.ExpenseFormComment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Prome.Viaticos.Server.Domain.Entities.ExpenseFormAggreate.ExpenseFormStatus", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Prome.Viaticos.Server.Domain.Entities.ExpenseAggregate.Expense", b =>
                {
                    ...
                    b.HasOne("Prome.Viaticos.Server.Domain.Entities.ExpenseFormAggreate.ExpenseForm", "ExpenseForm")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("Prome.Viaticos.Server.Domain.Entities.ExpenseFormAggreate.ExpenseForm", b =>
                {
                    ...
                    b.HasOne("Prome.Viaticos.Server.Domain.Entities.ExpenseFormAggreate.ExpenseFormStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

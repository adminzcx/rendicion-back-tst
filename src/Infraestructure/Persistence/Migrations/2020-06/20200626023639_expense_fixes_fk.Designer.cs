...
namespace Prome.Viaticos.Server.Infraestructure.Persistence.Migrations
{
    ...
    [Migration("20200626023639_expense_fixes_fk")]
    partial class expense_fixes_fk
    {
            ...
            modelBuilder.Entity("Prome.Viaticos.Server.Domain.Entities.ExpenseAggregate.Expense", b =>
                {
                    ...
                    b.Property<long?>("ExpenseFormId1")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Prome.Viaticos.Server.Domain.Entities.ExpenseAggregate.Expense", b =>
                {
                    ...
                    b.HasOne("Prome.Viaticos.Server.Domain.Entities.ExpenseFormAggregate.ExpenseForm", null)
                        .WithMany("Expenses")
                        .HasForeignKey("ExpenseFormId1");

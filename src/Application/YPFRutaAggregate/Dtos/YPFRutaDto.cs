...
namespace Prome.Viaticos.Server.Application.YPFRutaAggregate.Dtos
{
    public class YPFRutaDto : IMapFrom<Domain.Entities.YPFRutaAggregate.Datos_YPF>
    {
        ...
        {
            profile.CreateMap<Domain.Entities.YPFRutaAggregate.Datos_YPF, YPFRutaDto>()
                .ForMember(dest => dest.Identificacion_Tarjeta, m => m.MapFrom(source => source.Identificacion_Tarjeta));
        }*/
    }
}

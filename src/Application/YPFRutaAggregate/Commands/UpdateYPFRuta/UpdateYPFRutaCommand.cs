...
{
    public class UpdateYPFRutaCommand : IRequest, IMapFrom<Domain.Entities.YPFRutaAggregate.Datos_YPF>
    {
        ...
        {
            profile.CreateMap<UpdateYPFRutaCommand, Domain.Entities.YPFRutaAggregate.Datos_YPF>();
        }
    }
}

...
{
    public class LunchFormReportDto : IMapFrom<Domain.Entities.LunchFormAggregate.LunchForm>
    {
        ...
        public LunchFormStatus Status { get; set; }

        public bool IsPaid { get; set; }

        public void Mapping(Profile profile)
        {
            profile.CreateMap<Domain.Entities.LunchFormAggregate.LunchForm, LunchFormReportDto>()

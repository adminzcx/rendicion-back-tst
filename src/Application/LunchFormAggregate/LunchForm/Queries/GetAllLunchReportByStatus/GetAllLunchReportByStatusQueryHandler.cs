...
{
    public class GetAllLunchReportByStatusQueryHandler : QueryHandler<GetAllLunchReportByStatusQuery, ICollection<LunchFormReportDto>>
    {
        public GetAllLunchReportByStatusQueryHandler(
            IAsyncUnitOfWork unitOfWork,
            IMapper mapper)
            : base(unitOfWork, mapper)
        { }

        public override async Task<ICollection<LunchFormReportDto>> Handle(GetAllLunchReportByStatusQuery request, CancellationToken cancellationToken)
        {

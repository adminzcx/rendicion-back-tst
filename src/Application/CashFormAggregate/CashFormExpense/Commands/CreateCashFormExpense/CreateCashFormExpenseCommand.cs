...
{
    public class CreateCashFormExpenseCommand : IRequest, IMapFrom<Domain.Entities.CashFormAggregate.CashFormExpense>
    {
        ...
        {
            profile.CreateMap<CreateCashFormExpenseCommand, Domain.Entities.CashFormAggregate.CashFormExpense>()

...
{
    public class UpdateLunchCommand : IRequest, IMapFrom<Domain.Entities.LunchAggregate.Lunch>
    {
        ...
        {
            profile.CreateMap<UpdateLunchCommand, Domain.Entities.LunchAggregate.Lunch>()

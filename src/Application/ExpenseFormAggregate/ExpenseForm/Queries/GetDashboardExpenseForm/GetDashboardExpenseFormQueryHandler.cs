...
namespace Prome.Viaticos.Server.Application.ExpenseFormAggregate.ExpenseForm.Queries.GetDashboardExpenseForm
{
    ...
    public class GetDashboardExpenseFormQueryHandler : QueryHandler<GetDashboardExpenseFormQuery, ICollection<DashboardDto>>
    {
        public GetDashboardExpenseFormQueryHandler(
            IAsyncUnitOfWork unitOfWork,
            IMapper mapper)
            : base(unitOfWork, mapper)
        { }

        public override async Task<ICollection<DashboardDto>> Handle(GetDashboardExpenseFormQuery request, CancellationToken cancellationToken)
        {
